...
1. Run the four site scripts first. They will save outputs to your Desktop in `Defaunation_biotic_homogenization/<SITE>/`.
2. Then run this meta-analysis script, which reads those outputs and produces combined figures/tables.
...
### File paths
file_paths <- list(
  beta = "effects beta.xlsx",
  richness = "effects richness.xlsx",
  shannon = "effects shannon.xlsx",
  inverse_simpson = "effects inverse simpson.xlsx"
)
